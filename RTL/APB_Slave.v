    ...
    if (~PRESETn) begin
        ...
        if (PWRITE) begin     
            case (PSTRB)
                ...
                4'b0100: Cache[PADDR] <= {{8{PWDATA[23]}}, PWDATA[23:16], 16'h00}; // Store the third byte with zeroes in the least 16 bits
                4'b0101: Cache[PADDR] <= {{8{PWDATA[23]}}, PWDATA[23:16], 8'h00, PWDATA[7:0]}; // Store the third and least significant bytes with zeroes
